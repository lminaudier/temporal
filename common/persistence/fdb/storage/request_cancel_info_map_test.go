...
func TestRequestCancelInfoMapSaveAndLoad(t *testing.T) {
	...
	ss := dir.Sub("request_cancel_info_maps")
	defer func() {
	...
	repo := NewRequestCancelInfoMapRepository(db, ss)
